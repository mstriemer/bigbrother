...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field users on 'Gameshow'
        db.create_table('gameshow_gameshow_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gameshow', models.ForeignKey(orm['gameshow.gameshow'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('gameshow_gameshow_users', ['gameshow_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field users on 'Gameshow'
        db.delete_table('gameshow_gameshow_users')
