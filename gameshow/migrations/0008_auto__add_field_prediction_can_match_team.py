...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prediction.can_match_team'
        db.add_column('gameshow_prediction', 'can_match_team', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Prediction.can_match_team'
        db.delete_column('gameshow_prediction', 'can_match_team')
