...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gameshow.slug'
        db.add_column('gameshow_gameshow', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='bigbrother', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gameshow.slug'
        db.delete_column('gameshow_gameshow', 'slug')
