...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Team'
        db.create_table('gameshow_team', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('gameshow', ['Team'])

        # Adding model 'TeamMembership'
        db.create_table('gameshow_teammembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gameshow.Team'])),
            ('contestant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gameshow.Contestant'])),
        ))
        db.send_create_signal('gameshow', ['TeamMembership'])


    def backwards(self, orm):
        
        # Deleting model 'Team'
        db.delete_table('gameshow_team')

        # Deleting model 'TeamMembership'
        db.delete_table('gameshow_teammembership')
